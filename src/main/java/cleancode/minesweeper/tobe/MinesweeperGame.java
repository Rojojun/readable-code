...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int selctedRowIndex = Character.getNumericValue(cellInputRow) - 1;
            if (userActionInput.equals("2")) {
                board[selctedRowIndex][selectedColIndex] = "⚑";
                ...
                if (landMines[selctedRowIndex][selectedColIndex]) {
                    board[selctedRowIndex][selectedColIndex] = "☼";
                    gameStatus = -1;
                    continue;
                } else {
                    open(selctedRowIndex, selectedColIndex);
                }
